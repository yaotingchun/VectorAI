...
export const SEED_MACHINES: Machine[] = [
  // ==========================================
  // DEMO MACHINE: WB-024 (Wire Bonder - Warning)
  // ==========================================
  {
    id: 'WB-024',
    name: 'Wire Bonder 24',
  ...
  // ==========================================
  // OTHER MACHINES (12 additional instances)
  // ==========================================
  ...
  // WB-001 (Wire Bonder - Healthy)
  {
    ...
    healthTrend: {
      '24h': [
        { timestamp: '12h ago', health: 97 },
        { timestamp: '6h ago', health: 96 },
        { timestamp: 'Now', health: 96 }
      ],
      '7d': [
        { timestamp: 'Day 1', health: 98 },
        { timestamp: 'Day 4', health: 97 },
        { timestamp: 'Day 7', health: 96 }
      ],
      '30d': [
        { timestamp: 'Wk 1', health: 99 },
        { timestamp: 'Wk 2', health: 98 },
        { timestamp: 'Wk 3', health: 97 },
  ...
  // WB-003 (Wire Bonder - Critical)
  {
    ...
    documents: [],
    healthTrend: {
      '24h': [{ timestamp: '12h ago', health: 65 }, { timestamp: '6h ago', health: 50 }, { timestamp: 'Now', health: 41 }],
